...
@section('title', 'Dados do imovel | Processo #' . $process->id)

@section('content')
<div class="card space-y-8">
    <div class="space-y-2">
        <h1 class="text-2xl font-semibold text-slate-900">Dados do imovel</h1>
        <p class="text-sm text-slate-600">Informe ou ajuste as caracteristicas do imovel utilizado pela instituicao.</p>
    </div>

    <form method="POST" action="{{ route('etika.processes.property.update', $process) }}" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <section class="space-y-4">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <div class="space-y-1">
                    <label class="form-label" for="iptu_registration">Inscricao do IPTU</label>
                    <input id="iptu_registration" name="iptu_registration" type="text" class="form-control" value="{{ old('iptu_registration', optional($property)->iptu_registration) }}">
                </div>
                <div class="space-y-1">
        ...
        <section class="space-y-4">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                ...
                <div class="space-y-1">
                    <label class="form-label" for="land_area_sqm">Area do terreno (m2)</label>
        ...
        <section class="space-y-4">
            <h2 class="text-lg font-semibold">Uso e estrutura</h2>
            <div class="grid gap-4 md:grid-cols-2">
                <div class="space-y-1">
                ...
                <div class="space-y-1 md:col-span-2">
                    <label class="form-label" for="activity_floor">Andar das atividades</label>
                    <input id="activity_floor" name="activity_floor" type="text" class="form-control" value="{{ old('activity_floor', optional($property)->activity_floor) }}">
                </div>
            </div>
        </section>
